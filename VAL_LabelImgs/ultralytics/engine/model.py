...
from VAL_LabelImgs.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from VAL_LabelImgs.ultralytics.engine.results import Results
from VAL_LabelImgs.ultralytics.hub import HUB_WEB_ROOT, HUBTrainingSession
from VAL_LabelImgs.ultralytics.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        from VAL_LabelImgs.ultralytics import __version__
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from VAL_LabelImgs.ultralytics.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from VAL_LabelImgs.ultralytics.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from VAL_LabelImgs.ultralytics.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from VAL_LabelImgs.ultralytics.nn.autobackend import check_class_names
