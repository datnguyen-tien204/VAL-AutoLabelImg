...
class TQDM(tqdm_original):
    ...
    Examples:
        >>> from VAL_LabelImgs.ultralytics.utils import TQDM
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.5"):
        ...
        from VAL_LabelImgs.ultralytics.utils.torch_utils import torch_distributed_zero_first
...
from VAL_LabelImgs.ultralytics.utils.patches import imread, imshow, imwrite, torch_load, torch_save
