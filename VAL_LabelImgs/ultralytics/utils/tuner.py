...
from VAL_LabelImgs.ultralytics.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from VAL_LabelImgs.ultralytics.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
