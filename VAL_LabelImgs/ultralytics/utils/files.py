...
def spaces_in_path(path):
    ...
    Examples:
        ...
        >>> from VAL_LabelImgs.ultralytics.utils.files import spaces_in_path
...
def update_models(model_names=("yolov8n.pt",), source_dir=Path("."), update_names=False):
    ...
    Examples:
        ...
        >>> from VAL_LabelImgs.ultralytics.utils.files import update_models
        >>> model_names = ("yolov8n.pt", "yolov8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from VAL_LabelImgs.ultralytics import YOLO
    from VAL_LabelImgs.ultralytics.nn.autobackend import default_class_names
