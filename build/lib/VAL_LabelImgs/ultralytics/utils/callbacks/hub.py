...
from VAL_LabelImgs.ultralytics.hub import HUB_WEB_ROOT, PREFIX, HUBTrainingSession, events
from VAL_LabelImgs.ultralytics.utils import LOGGER, RANK, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from VAL_LabelImgs.ultralytics.utils.torch_utils import model_info_for_loggers
