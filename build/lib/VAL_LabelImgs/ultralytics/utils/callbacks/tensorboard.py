...
from VAL_LabelImgs.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from VAL_LabelImgs.ultralytics.utils.torch_utils import de_parallel, torch
